	...
	<body>
		...
		<div class="container">
			...
			<div style="text-align: center;">
				<ul class="pagination">
					<li <c:if test="${ pageBean.currPage == 1 }"> class="disabled" </c:if>><a href="${ pageContext.request.contextPath}/OrderServlet?mthod=findByUid&currPage=${pageBean.currPage-1}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
					...
					<c:if test="${ pageBean.currPage != pageBean.totalPage }">
						<li>
							<a href="${ pageContext.request.contextPath }/OrderServlet?mthod=findByUid&currPage=${pageBean.currPage+1}" aria-label="Next">
								<span aria-hidden="true">&raquo;</span>
							</a>
						</li>
					</c:if>
